          ...
          <div className="col-12 col-md-6">
            <div className="link-wrapper">
              <ul className="m-0 list-unstyled">
                <li>
                  <a href="#!" className="link-opacity-75-hover text-decoration-none link-light fs-1 lh-sm">Shop</a>
                </li>
                <li>
                  <a href="#!" className="link-opacity-75-hover text-decoration-none link-light fs-1 lh-sm">Products</a>
                </li>
                <li>
                  <a href="#!" className="link-opacity-75-hover text-decoration-none link-light fs-1 lh-sm">Offers</a>
                </li>
                <li>
                  <a href="#!" className="link-opacity-75-hover text-decoration-none link-light fs-1 lh-sm">Clearance</a>
                </li>
                <li>
                  <a href="#!" className="link-opacity-75-hover text-decoration-none link-light fs-1 lh-sm">Releases</a>
                </li>
                <li>
                  <a href="#!" className="link-opacity-75-hover text-decoration-none link-light fs-1 lh-sm">Deals</a>
                </li>
                <li>
                  <a href="#!" className="link-opacity-75-hover text-decoration-none link-light fs-1 lh-sm">Contact</a>
                </li>
              </ul>
            </div>
          </div>
